...
export default function Header() {
    return (
      ...
      <div className="mx-auto justify-between flex bg-gradient-to-l from-red-800 to-slate-700 h-14">
          <div className="flex w-24 mx-2 font-extrabold text-3xl text-red-700 hover:animate-bounce hover:items-end items-center hover:text-black hover:cursor-pointer">ABCS</div>
